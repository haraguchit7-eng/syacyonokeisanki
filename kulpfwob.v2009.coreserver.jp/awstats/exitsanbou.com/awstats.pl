...
sub Read_Config {
	...
	# Standard, Mandrake and Debian package :	"/home/kulpfwob/domains/kulpfwob.v2009.coreserver.jp/awstats/exitsanbou.com/.data"
	# Other possible directories :				"/usr/local/etc/awstats",
	# FHS standard, Suse package : 				"/etc/opt/awstats"
	my $configdir         = shift;
	my @PossibleConfigDir = (
			"$DIR",
			"/home/kulpfwob/domains/kulpfwob.v2009.coreserver.jp/awstats/exitsanbou.com/.data",
